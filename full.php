...
<body>
 ...
 <?php include('security.php'); ?>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/full.jpg')">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <?php  
        $abc = $_GET['varname'];
        $finalval = Encryption::decode($abc);

        $sql = "SELECT * FROM blogs where blg_id='".$finalval."'";
      ...
      //  echo die();
        ...
        <div class="post-preview">
            ...
            <h1 style="color: #329284;" class="post-title">
              <?php echo $row['blg_title']; ?>
            </h2><hr style="color: #ccc;">
            <h4 class="post-subtitle">
              <?php echo $row['blg_description']; ?> 
        ...
        <!-- Pager -->
        <div class="clearfix">
          <a class="btn btn-primary float-right" href="index.php">BACK &rarr;</a>
        </div>
      </div>
    </div>
  </div>
