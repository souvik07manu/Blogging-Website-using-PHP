...
<body>
 ...
 <?php include('security.php'); ?>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/mypost.jpg')">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
          ...
          $blguserid = $_SESSION['u_id'];
      		$total_pages_sql = "SELECT COUNT(*) FROM blogs where blg_u_id = '".$blguserid."'";
	        $result = mysqli_query($conn,$total_pages_sql);
	        $total_rows = mysqli_fetch_array($result)[0];
	        $total_pages = ceil($total_rows / $no_of_records_per_page);

	        $sql = "SELECT * FROM blogs where blg_u_id = '".$blguserid."' LIMIT $offset, $no_of_records_per_page";
