   ...
   <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <div class="alert alert-primary" role="alert">
          Phone:  <?php echo $row['u_phone']; ?>
        </div>
        <div class="alert alert-secondary" role="alert">
          Address:  <?php echo $row['u_address']; ?>
        </div>

        <a href="myblog.php" id="regcl" class="btn btn-warning btn-block">MyPost</a><br/>

        <a href="editprofile.php" id="regclh" class="btn btn-success btn-block">Edit Profile</a>
        <a href="logout.php" id="regclf" class="btn btn-outline-danger btn-block">Logout</a>
